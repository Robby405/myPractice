...
function() {
    var $ = function() {
        ...
        function n() {
            q.addEventListener ? (q.removeEventListener("DOMContentLoaded", r, !1), window.removeEventListener("load", r, !1)) : (q.detachEvent("onreadystatechange", r), window.detachEvent("onload", r))
        }
        function r() { (q.addEventListener || "load" === event.type || "complete" === q.readyState) && (n(), D.ready())
        }
        function a(e, t, n) {
        ...
        function o(e, t, n, r) {
            if (D.acceptData(e)) {
                ...
                c = s ? D.cache: e,
                u = s ? e[o] : e[o] && o;
                if (u && c[u] && (r || c[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[o] = g.pop() || D.guid++:o),
                c[u] || (c[u] = s ? {}: {
                    toJSON: D.noop
                }),
            ...
            if (D.acceptData(e)) {
                ...
                if (s[c]) {
                    if (t && (r = n ? s[c] : s[c].data)) {
                        D.isArray(t) ? t = t.concat(D.map(t, D.camelCase)) : t in r ? t = [t] : (t = D.camelCase(t), t = t in r ? [t] : t.split(" ")),
                        a = t.length;
                        for (; a--;) delete r[t[a]];
                        if (n ? !i(r) : !D.isEmptyObject(r)) return
                    } (n || (delete s[c].data, i(s[c]))) && (o ? D.cleanData([e], !0) : C.deleteExpando || s != s.window ? delete s[c] : s[c] = null)
                }
            }
        }
        function c() {
        ...
        function l(e) {
            return function(t, n) {
                ...
                if (D.isFunction(n)) for (; r = i[a++];)"+" === r.charAt(0) ? (r = r.slice(1) || "*", (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n)
            }
        }
        function d(e, t, n, r) {
            function a(s) {
        ...
        function h(e, t, n, r) {
            ...
            for (i = l.shift(); i;) if (e.responseFields[i] && (n[e.responseFields[i]] = t), !c && r && e.dataFilter && (t = e.dataFilter(t, e.dataType)), c = i, i = l.shift()) if ("*" === i) i = c;
                ...
                if (! (o = u[c + " " + i] || u["* " + i])) for (a in u) if (s = a.split(" "), s[1] === i && (o = u[c + " " + s[0]] || u["* " + s[0]])) { ! 0 === o ? o = u[a] : !0 !== u[a] && (i = s[0], l.unshift(s[1]));
                    break
                }
        ...
        D.extend = D.fn.extend = function() {
            ...
            s++), "object" == typeof o || D.isFunction(o) || (o = {}), s === c && (o = this, s--); s < c; s++) if (null != (a = arguments[s])) for (r in a) e = o[r],
            n = a[r],
            o !== n && (u && n && (D.isPlainObject(n) || (t = D.isArray(n))) ? (t ? (t = !1, i = e && D.isArray(e) ? e: []) : i = e && D.isPlainObject(e) ? e: {},
        ...
        D.extend({
            ...
            merge: function(e, t) {
                for (var n = +t.length,
                r = 0,
                a = e.length; r < n;) e[a++] = t[r++];
                if (n !== n) for (; void 0 !== t[r];) e[a++] = t[r++];
                return e.length = a,
                e
            },
            grep: function(e, t, n) {
                for (var a = [], i = 0, o = e.length, s = !n; i < o; i++) ! t(e[i], i) !== s && a.push(e[i]);
                return a
            },
            map: function(t, n, r) {
                var a, i = 0,
            ...
            proxy: function(e, t) {
                var n, r, a;
                if ("string" == typeof t && (a = e[t], t = e, e = a), D.isFunction(e)) return n = x.call(arguments, 2),
                r = function() {
        ...
        var O, q = window.document,
        H = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/; (D.fn.init = function(e, t) {
            var n, r;
            if (!e) return this;
            if ("string" == typeof e) {
                if (! (n = "<" === e.charAt(0) && ">" === e.charAt(e.length - 1) && e.length >= 3 ? [null, e, null] : H.exec(e)) || !n[1] && t) return ! t || t.jquery ? (t || O).find(e) : this.constructor(t).find(e);
                if (n[1]) {
                    if (t = t instanceof D ? t[0] : t, D.merge(this, D.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t: q, !0)), rsingleTag.test(n[1]) && D.isPlainObject(t)) for (n in t) D.isFunction(this[n]) ? this[n](t[n]) : this.attr(n, t[n]);
                    return this
                }
            ...
            return e.nodeType ? (this.context = this[0] = e, this.length = 1, this) : D.isFunction(e) ? void 0 !== O.ready ? O.ready(e) : e(D) : (void 0 !== e.selector && (this.selector = e.selector, this.context = e.context), D.makeArray(e, this))
        }).prototype = D.fn,
        O = D(q);
        var P = /\S+/g,
        M = {};
        D.Callbacks = function(e) {
            e = "string" == typeof e ? M[e] || t(e) : D.extend({},
            e);
            var n, r, a, i, o, s, c = [],
            u = !e.once && [],
            l = function(t) {
                for (r = e.memory && t, a = !0, o = s || 0, s = 0, i = c.length, n = !0; c && o < i; o++) if (!1 === c[o].apply(t[0], t[1]) && e.stopOnFalse) {
                    r = !1;
                    break
                }
                n = !1,
            ...
            d = {
                ...
                remove: function() {
                    return c && D.each(arguments,
                    function(e, t) {
                        for (var r; (r = D.inArray(t, c, r)) > -1;) c.splice(r, 1),
                        n && (r <= i && i--, r <= o && o--)
                    }),
                    this
                },
                ...
                fireWith: function(e, t) {
                    return ! c || a && !u || (t = t || [], t = [e, t.slice ? t.slice() : t], n ? u.push(t) : l(t)),
                    this
                },
                fire: function() {
        ...
        D.extend({
            ...
            when: function(e) {
                ...
                if (o > 1) for (t = new Array(o), n = new Array(o), r = new Array(o); a < o; a++) i[a] && D.isFunction(i[a].promise) ? i[a].promise().done(u(a, r, i)).fail(c.reject).progress(u(a, n, t)) : --s;
        ...
        D.extend({
            ...
            ready: function(e) {
                if (!0 === e ? !--D.readyWait: !D.isReady) {
                    ...
                    D.isReady = !0,
                    !0 !== e && --D.readyWait > 0 || (W.resolveWith(q, [D]), D.fn.triggerHandler && (D(q).triggerHandler("ready"), D(q).off("ready")))
                }
            }
        }),
        D.ready.promise = function(e) {
            if (!W) if (W = D.Deferred(), "complete" === q.readyState) setTimeout(D.ready);
            else if (q.addEventListener) q.addEventListener("DOMContentLoaded", r, !1),
            ...
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (i = D.data(o), 1 === o.nodeType && !D._data(o, "parsedAttrs"))) {
                        for (n = s.length; n--;) s[n] && (r = s[n].name, 0 === r.indexOf("data-") && (r = D.camelCase(r.slice(5)), a(o, r, i[r])));
        ...
        D.fn.extend({
            ...
            promise: function(e, t) {
                ...
                i = this,
                o = this.length,
                s = function() {--r || a.resolveWith(i, [i])
                };
                for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; o--;)(n = D._data(i[o], e + "queueHooks")) && n.empty && (r++, n.empty.add(s));
                return s(),
                a.promise(t)
            }
        }),
        D.event = {
            ...
            add: function(e, t, n, r, a) {
                ...
                if (y) {
                    for (n.handler && (c = n, n = c.handler, a = c.selector), n.guid || (n.guid = D.guid++), (o = y.events) || (o = y.events = {}), (l = y.handle) || (l = y.handle = function(e) {
                        return typeof D === X || e && D.event.triggered === e.type ? void 0 : D.event.dispatch.apply(l.elem, arguments)
                    },
                    l.elem = e), t = (t || "").match(P) || [""], s = t.length; s--;) i = U.exec(t[s]) || [],
                    p = v = i[1],
                    h = (i[2] || "").split(".").sort(),
                    p && (u = D.event.special[p] || {},
                    p = (a ? u.delegateType: u.bindType) || p, u = D.event.special[p] || {},
                    d = D.extend({
                        type: p,
                        origType: v,
                        data: r,
                    ...
                    c), (f = o[p]) || (f = o[p] = [], f.delegateCount = 0, u.setup && !1 !== u.setup.call(e, r, h, l) || (e.addEventListener ? e.addEventListener(p, l, !1) : e.attachEvent && e.attachEvent("on" + p, l))), u.add && (u.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), a ? f.splice(f.delegateCount++, 0, d) : f.push(d), D.event.global[p] = !0);
                    e = null
                }
            },
            remove: function(e, t, n, r, a) {
                ...
                if (y && (l = y.events)) {
                    for (t = (t || "").match(P) || [""], u = t.length; u--;) if (s = U.exec(t[u]) || [], p = v = s[1], h = (s[2] || "").split(".").sort(), p) {
                        for (d = D.event.special[p] || {},
                        p = (r ? d.delegateType: d.bindType) || p, f = l[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), c = i = f.length; i--;) o = f[i],
                        !a && v !== o.origType || n && n.guid !== o.guid || s && !s.test(o.namespace) || r && r !== o.selector && ("**" !== r || !o.selector) || (f.splice(i, 1), o.selector && f.delegateCount--, d.remove && d.remove.call(e, o));
                        c && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, y.handle) || D.removeEvent(e, p, y.handle), delete l[p])
                    } else for (p in l) D.event.remove(e, p + t[u], n, r, !0);
                    D.isEmptyObject(l) && (delete y.handle, D._removeData(e, "events"))
                }
            },
            trigger: function(e, t, n, r) {
                var a, i, o, s, c, u, l, d = [n || q],
                f = S.call(e, "type") ? e.type: e,
                p = S.call(e, "namespace") ? e.namespace.split(".") : [];
                if (o = u = n = n || q, 3 !== n.nodeType && 8 !== n.nodeType && !K.test(f + D.event.triggered) && (f.indexOf(".") >= 0 && (p = f.split("."), f = p.shift(), p.sort()), i = f.indexOf(":") < 0 && "on" + f, e = e[D.expando] ? e: new D.Event(f, "object" == typeof e && e), e.isTrigger = r ? 2 : 3, e.namespace = p.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : D.makeArray(t, [e]), c = D.event.special[f] || {},
                r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                    if (!r && !c.noBubble && !D.isWindow(n)) {
                        for (s = c.delegateType || f, K.test(s + f) || (o = o.parentNode); o; o = o.parentNode) d.push(o),
                        u = o;
                        u === (n.ownerDocument || q) && d.push(u.defaultView || u.parentWindow || window)
                    }
                    for (l = 0; (o = d[l++]) && !e.isPropagationStopped();) e.type = l > 1 ? s: c.bindType || f,
                    a = (D._data(o, "events") || {})[e.type] && D._data(o, "handle"),
                    a && a.apply(o, t),
                    (a = i && o[i]) && a.apply && D.acceptData(o) && (e.result = a.apply(o, t), !1 === e.result && e.preventDefault());
                    if (e.type = f, !r && !e.isDefaultPrevented() && (!c._default || !1 === c._default.apply(d.pop(), t)) && D.acceptData(n) && i && n[f] && !D.isWindow(n)) {
                        u = n[i],
                        u && (n[i] = null),
                        D.event.triggered = f;
                        try {
            ...
            fix: function(e) {
                ...
                i = e,
                o = this.fixHooks[a];
                for (o || (this.fixHooks[a] = o = z.test(a) ? this.mouseHooks: J.test(a) ? this.keyHooks: {}), r = o.props ? this.props.concat(o.props) : this.props, e = new D.Event(i), t = r.length; t--;) n = r[t],
                e[n] = i[n];
            ...
            mouseHooks: {
                ...
                filter: function(e, t) {
                    ...
                    o = t.fromElement;
                    return null == e.pageX && null != t.clientX && (r = e.target.ownerDocument || q, a = r.documentElement, n = r.body, e.pageX = t.clientX + (a && a.scrollLeft || n && n.scrollLeft || 0) - (a && a.clientLeft || n && n.clientLeft || 0), e.pageY = t.clientY + (a && a.scrollTop || n && n.scrollTop || 0) - (a && a.clientTop || n && n.clientTop || 0)),
            ...
            special: {
                ...
                click: {
                    trigger: function() {
                        if (D.nodeName(this, "input") && "checkbox" === this.type && this.click) return this.click(),
                        !1
                    },
                    _default: function(e) {
        ...
        D.Event = function(e, t) {
            return this instanceof D.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? c: u) : this.type = e, t && D.extend(this, t), this.timeStamp = e && e.timeStamp || D.now(), void(this[D.expando] = !0)) : new D.Event(e, t)
        };
        ...
        C.submitBubbles || (D.event.special.submit = {
            setup: function() {
                return ! D.nodeName(this, "form") && void D.event.add(this, "click._submit keypress._submit",
                function(e) {
                    var t = e.target,
                    n = D.nodeName(t, "input") || D.nodeName(t, "button") ? t.form: void 0;
                    n && !D._data(n, "submitBubbles") && (D.event.add(n, "submit._submit",
                    function(e) {
                        e._submit_bubble = !0
        ...
        C.changeBubbles || (D.event.special.change = {
            setup: function() {
                return I.test(this.nodeName) ? ("checkbox" !== this.type && "radio" !== this.type || (D.event.add(this, "propertychange._change",
                function(e) {
                    "checked" === e.originalEvent.propertyName && (this._just_changed = !0)
                }), D.event.add(this, "click._change",
                function(e) {
                    this._just_changed && !e.isTrigger && (this._just_changed = !1),
                    D.event.simulate("change", this, e, !0)
                })), !1) : void D.event.add(this, "beforeactivate._change",
                function(e) {
                    var t = e.target;
                    I.test(t.nodeName) && !D._data(t, "changeBubbles") && (D.event.add(t, "change._change",
                    function(e) { ! this.parentNode || e.isSimulated || e.isTrigger || D.event.simulate("change", this.parentNode, e, !0)
        ...
        D.fn.extend({
            on: function(e, t, n, r, a) {
                ...
                if (null == n && null == r ? (r = t, n = t = void 0) : null == r && ("string" == typeof t ? (r = n, n = void 0) : (r = n, n = t, t = void 0)), !1 === r) r = u;
            ...
            ajax: function(e, t) {
                ...
                E = {
                    ...
                    statusCode: function(e) {
                        var t;
                        if (e) if (j < 2) for (t in e) x[t] = [x[t], e[t]];
                ...
                if (m.promise(E).complete = g.add, E.success = E.done, E.error = E.fail, f.url = ((e || f.url || Z) + "").replace(/#.*$/, "").replace(/^\/\//, Q[1] + "//"), f.type = t.method || t.type || f.method || f.type, f.dataTypes = D.trim(f.dataType || "*").toLowerCase().match(P) || [""], null == f.crossDomain && (r = oe.exec(f.url.toLowerCase()), f.crossDomain = !(!r || r[1] === Q[1] && r[2] === Q[2] && (r[3] || ("http:" === r[1] ? "80": "443")) === (Q[3] || ("http:" === Q[1] ? "80": "443")))), f.data && f.processData && "string" != typeof f.data && (f.data = D.param(f.data, f.traditional)), d(se, f, t, E), 2 === j) return E;
                c = f.global,
                c && 0 == D.active++&&D.event.trigger("ajaxStart"),
                f.type = f.type.toUpperCase(),
                f.hasContent = !ae.test(f.type),
                i = f.url,
                f.hasContent || (f.data && (i = f.url += (G.test(i) ? "&": "?") + f.data, delete f.data), !1 === f.cache && (f.url = te.test(i) ? i.replace(te, "$1_=" + Y++) : i + (G.test(i) ? "&": "?") + "_=" + Y++)),
                f.ifModified && (D.lastModified[i] && E.setRequestHeader("If-Modified-Since", D.lastModified[i]), D.etag[i] && E.setRequestHeader("If-None-Match", D.etag[i])),
        ...
        function(e, t) {
            D[t] = function(e, n, r, a) {
                return D.isFunction(n) && (a = a || r, r = n, n = void 0),
                D.ajax({
                    url: e,
                    type: t,
                    dataType: a,
        ...
        D.param = function(e, t) {
            ...
            if (void 0 === t && (t = D.ajaxSettings && D.ajaxSettings.traditional), D.isArray(e) || e.jquery && !D.isPlainObject(e)) D.each(e,
            function() {
        ...
        D.ajaxSettings.xhr = void 0 !== window.ActiveXObject ?
        function() {
        ...
        window.ActiveXObject && D(window).on("unload",
        function() {
            ...
            if (!e.crossDomain || C.cors) {
                ...
                return {
                    send: function(n, r) {
                        ...
                        t = function(n, a) {
                            var s, c, u;
                            if (t && (a || 4 === i.readyState)) if (delete me[o], t = void 0, i.onreadystatechange = D.noop, a) 4 !== i.readyState && i.abort();
                            else {
                                u = {},
                                s = i.status,
        ...
        function(e, t, n) {
            ...
            if (o || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = D.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
        ...
        D.parseHTML = function(e, t, n) {
            ...
            a = !n && [];
            return r ? [t.createElement(r[1])] : (r = D.buildFragment([e], t, a), a && a.length && D(a).remove(), D.merge([], r.childNodes))
        },
        D
    } (),
    jsSHA = function() {
        function r(r, i, f) {
            var s, l, E, b, v, g, A, d, F, w = 0,
            R = [],
            B = 0,
            U = !1,
            y = [],
            ...
            T = !1;
            if (f = f || {},
            s = f.encoding || "UTF8", (F = f.numRounds || 1) !== parseInt(F, 10) || 1 > F) throw Error("numRounds must a integer >= 1");
            ...
            this.setHMACKey = function(t, n, e) {
                ...
                if (s = (e || {}).encoding || "UTF8", n = u(n, s)(t), t = n.binLen, n = n.value, o = v >>> 3, e = o / 4 - 1, o < t / 8) {
                ...
                for (t = 0; t <= e; t += 1) y[t] = 909522486 ^ n[t],
                H[t] = 1549556828 ^ n[t];
                l = g(y, l),
                w = v,
                U = !0
            ...
            this.update = function(r) {
                var t, n, e, o = 0,
                a = v >>> 5;
                for (t = E(r, R, B), r = t.binLen, n = t.value, t = r >>> 5, e = 0; e < t; e += a) o + v <= r && (l = g(n.slice(e, e + a), l), o += v);
                w += o,
                R = n.slice(o >>> 5),
                B = r % v,
                T = !0;
        ...
        function t(r, t, n) {
            ...
            t /= 8;
            var o, a;
            for (o = 0; o < t; o += 1) a = r[o >>> 2] >>> 8 * (3 + o % 4 * -1),
        ...
        function n(r, t, n) {
            var e, o, a, u = "",
            i = t / 8;
            for (e = 0; e < i; e += 3) for (o = e + 1 < i ? r[e + 1 >>> 2] : 0, a = e + 2 < i ? r[e + 2 >>> 2] : 0, a = (r[e >>> 2] >>> 8 * (3 + e % 4 * -1) & 255) << 16 | (o >>> 8 * (3 + (e + 1) % 4 * -1) & 255) << 8 | a >>> 8 * (3 + (e + 2) % 4 * -1) & 255, o = 0; 4 > o; o += 1) u += 8 * e + 6 * o <= t ? "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(a >>> 6 * (3 - o) & 63) : n.b64Pad;
            return u
        }
        function e(r, t) {
            var n, e, o = "",
            a = t / 8;
            for (n = 0; n < a; n += 1) e = r[n >>> 2] >>> 8 * (3 + n % 4 * -1) & 255,
        ...
        function a(r) {
            ...
            if (r = r || {},
            t.outputUpper = r.outputUpper || !1, !0 === r.hasOwnProperty("b64Pad") && (t.b64Pad = r.b64Pad), "boolean" != typeof t.outputUpper) throw Error("Invalid outputUpper formatting option");
        ...
        function u(r, t) {
            ...
            case "TEXT":
                n = function(r, n, e) {
                    ...
                    if (n = n || [0], e = e || 0, f = e >>> 3, "UTF8" === t) for (h = 3, u = 0; u < r.length; u += 1) for (o = r.charCodeAt(u), a = [], 128 > o ? a.push(o) : 2048 > o ? (a.push(192 | o >>> 6), a.push(128 | 63 & o)) : 55296 > o || 57344 <= o ? a.push(224 | o >>> 12, 128 | o >>> 6 & 63, 128 | 63 & o) : (u += 1, o = 65536 + ((1023 & o) << 10 | 1023 & r.charCodeAt(u)), a.push(240 | o >>> 18, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o)), i = 0; i < a.length; i += 1) {
                        for (c = p + f, s = c >>> 2; n.length <= s;) n.push(0);
                        n[s] |= a[i] << 8 * (h + c % 4 * -1),
                        p += 1
                    } else if ("UTF16BE" === t || "UTF16LE" === t) for (h = 2, u = 0; u < r.length; u += 1) {
                        for (o = r.charCodeAt(u), "UTF16LE" === t && (i = 255 & o, o = i << 8 | o >>> 8), c = p + f, s = c >>> 2; n.length <= s;) n.push(0);
                        n[s] |= o << 8 * (h + c % 4 * -1),
                        p += 2
                    }
                    return {
            ...
            case "BYTES":
                n = function(r, t, n) {
                    var e, o, a, u, i;
                    for (t = t || [0], n = n || 0, a = n >>> 3, o = 0; o < r.length; o += 1) e = r.charCodeAt(o),
                    i = o + a,
                    u = i >>> 2,
                    t.length <= u && t.push(0),
                    t[u] |= e << 8 * (3 + i % 4 * -1);
            ...
            case "ARRAYBUFFER":
                ...
                n = function(r, t, n) {
                    var e, o, a, u;
                    for (t = t || [0], n = n || 0, o = n >>> 3, e = 0; e < r.byteLength; e += 1) u = e + o,
                    a = u >>> 2,
                    t.length <= a && t.push(0),
                    t[a] |= r[e] << 8 * (3 + u % 4 * -1);
                    return {
        ...
        function h(r, t) {
            var n, e, o, a, u, c, h, p = [];
            for (n = t[0], e = t[1], o = t[2], a = t[3], u = t[4], h = 0; 80 > h; h += 1) p[h] = 16 > h ? r[h] : i(p[h - 3] ^ p[h - 8] ^ p[h - 14] ^ p[h - 16], 1),
        ...
        function p(r, t, n, e) {
            ...
            for (r[t >>> 5] |= 128 << 24 - t % 32, t += n, r[o] = 4294967295 & t, r[o - 1] = t / 4294967296 | 0, t = r.length, o = 0; o < t; o += 16) e = h(r.slice(o, o + 16), e);
            return e
        }
        return r
    } (); !
    ...
    function() {
        ...
        function s(e) {
            ...
            $.ajax({
                ...
                data: s,
                success: function(a) {
                    if ("cancel" !== e.globalTask.state) if (a = a || {},
                    0 == a.code) {
                        ...
                        for (var p, c = {},
                        l = 1; l < e.uploadparts.length; l *= 2) p = e.uploadparts[l - 1],
        ...
        function i(e) {
            ...
            function() {
                var t, a = {};
                if (e.listparts) for (t = 0; t < e.listparts.length; t++) a[e.listparts[t].offset] = e.listparts[t];
                for (t = 0; t < s.chunkCount; t++) {
                    ...
                    a[o] ? (s.loadedSize += r.size, r.state = "online") : r.state = "waiting",
                    s.chunks.push(r)
                }
            } ();
            var i = function() {
                    ...
                    for (; a._uploadingThreadCount < a.uploadMaxThread && s.currentIndex < s.chunkCount; s.currentIndex++) {
                        ...
                        function(e) {
                            ...
                            function(t, n) {
                                s.uploadingCount--,
                                a._uploadingThreadCount--,
                                t ? (e.state = "error", r(0, n)) : (e.state = "success", s.uploadingCount <= 0 && s.currentIndex >= s.chunkCount ? i() : p())
                            })
                        } (t)
                    }
                    ...
                    success: function(t) {
                        ...
                        0 == t.code) {
                            ...
                            if (s) {
                                ...
                                r = i.offset;
                                if (r + i.datalen > n.size) return a.resolve(),
                                a.promise();
                                e.offset = r
                            }
                            a.resolve(t)
        ...
        function c(e) {
            ...
            FileReader.prototype.readAsBinaryString ? t = FileReader.prototype.readAsBinaryString: FileReader.prototype.readAsArrayBuffer ? t = function(e) {
                ...
                n = new FileReader;
                n.onload = function(e) {
                    for (var o = new Uint8Array(n.result), s = o.byteLength, i = 0; i < s; i++) t += String.fromCharCode(o[i]);
                    a.content = t,
                    a.onload()
                },
        ...
        e.prototype.set = function(e) {
            e && (this.appid = e.appid, this.bucket = e.bucket, this.region = e.region, e.getAppSign && (this.getAppSign = e.getAppSign), e.getAppSignOnce && (this.getAppSignOnce = e.getAppSignOnce))
        },
        ...
        e.prototype.uploadFile = function(e, t, o, s, i, r, p, c) {
            var l = this;
            if (r.size > 20971520) return void l.sliceUploadFile(e, t, o, s, i, r, p, void 0, void 0, c);
            if ("/" === i.substr(i.length - 1)) return void t({
                code: -1,
        ...
        e.prototype.sliceUploadFile = function(e, t, c, l, u, d, f, g, h, v) {
            if ("/" === u.substr(u.length - 1)) return void t({
                code: -1,
                message: 'path not allow end with "/"'
            });
            var y = a(),
            ...
            m.getAppSign(function(a) {
                var n = {};
                n.globalTask = S,
                "cancel" !== n.globalTask.state && (g = m.getSliceSize(g), n.bucket = l, n.path = u, n.file = d, n.insertOnly = 0 === f ? 0 : 1, n.sliceSize = g || 1048576, n.appid = m.appid, n.sign = a, n.biz_attr = h || "", n.onprogress = function(e, t) {
                    void 0 === t && (t = 1),
                    c(e, t)
                },
                r.call(m, n).always(function(a) {
                    if ("cancel" !== n.globalTask.state) {
                        ...
                        var r = a.data;
                        if (r && r.session) {
                            if (r.filesize !== n.file.size) return t({
                                code: -1,
                                message: "filesize not match"
                            });
                            var c = n.listparts || [];
                            if (n.session = r.session, n.listparts = c, c && c.length) {
                                var l = c.length;
                        ...
                        } else r && r.access_url && 0 !== f ? ("function" == typeof n.onprogress && n.onprogress(1, 0), e(a)) : o.call(m, n).done(function(a) {
                            if ("cancel" !== n.globalTask.state) {
                                n.uploadparts = a;
                                var o = a.length;
                                n.sha = a[o - 1].datasha,
                                s.call(m, n).done(function(a) {
                                    if ("cancel" !== n.globalTask.state) {
                                        a = a || {};
                                        var o = a.data || {};
                                        o && o.access_url ? ("function" == typeof n.onprogress && n.onprogress(1, 0), e(a)) : p.call(m, n).done(function(t) {
                                            e(t)
                                        }).fail(function(e) {
                                            t({
                                                code: -1,
        ...
        v = function(e, t, a) {
            ...
            f = d.size,
            g = function(t) {
                for (var a = e.uploadingAjax.length - 1; a >= 0; a--) t === e.uploadingAjax[a] && e.uploadingAjax.splice(a, 1)
            },
            h = 0,
            v = function(t, a) {
                e.loadedSize += t - h,
...
function(g, l) {
    ...
    p = d.WordArray = k.extend({
        ...
        concat: function(a) {
            ...
            q = a.words,
            f = this.sigBytes;
            if (a = a.sigBytes, this.clamp(), f % 4) for (var b = 0; b < a; b++) c[f + b >>> 2] |= (q[b >>> 2] >>> 24 - b % 4 * 8 & 255) << 24 - (f + b) % 4 * 8;
    ...
    n = b.Hex = {
        ...
        parse: function(a) {
            for (var c = a.length,
            b = [], f = 0; f < c; f += 2) b[f >>> 3] |= parseInt(a.substr(f, 2), 16) << 24 - f % 8 * 4;
    ...
    j = b.Latin1 = {
        ...
        parse: function(a) {
            for (var c = a.length,
            b = [], f = 0; f < c; f++) b[f >>> 2] |= (255 & a.charCodeAt(f)) << 24 - f % 4 * 8;
...
function() {
    ...
    l = g.algo.SHA1 = d.extend({
        ...
        _doProcessBlock: function(d, e) {
            ...
            n = b[0], j = b[1], h = b[2], g = b[3], l = b[4], a = 0; 80 > a; a++) {
                if (16 > a) m[a] = 0 | d[e + a];
                else {
...
function() {
    ...
    C_enc.Base64 = {
        stringify: function(wordArray) {
            ...
            map = this._map;
            wordArray.clamp();
            for (var base64Chars = [], i = 0; i < sigBytes; i += 3) for (var byte1 = words[i >>> 2] >>> 24 - i % 4 * 8 & 255, byte2 = words[i + 1 >>> 2] >>> 24 - (i + 1) % 4 * 8 & 255, byte3 = words[i + 2 >>> 2] >>> 24 - (i + 2) % 4 * 8 & 255, triplet = byte1 << 16 | byte2 << 8 | byte3, j = 0; j < 4 && i + .75 * j < sigBytes; j++) base64Chars.push(map.charAt(triplet >>> 6 * (3 - j) & 63));
...
function() {
    ...
    function cancelUpload(opts) {
        return "object" != getType(opts) ? "å‚æ•°å¿…é¡»ä¸ºå¯¹è±¡ç±»åž‹": opts.cos && opts.taskId ? "string" != getType(opts.taskId) ? "taskIdæ ¼å¼é”™è¯¯": opts.cos && "function" != getType(opts.cos.cancelTask) ? "cosæ ¼å¼é”™è¯¯": void opts.cos.cancelTask(opts.taskId) : "cos/taskIdä¸èƒ½ä¸ºç©º"
    }
    ...
    getFileMessage = function(file, newname) {
        ...
        fileMsg.error = "",
        (void 0 == fileMsg.name || "" == fileMsg.name || /[:*?,<>\'\"\\]/g.test(fileMsg.name)) && (fileMsg.error = 'æ–‡ä»¶åä¸å¾—åŒ…å« / : * ? "  < > ç­‰å­—ç¬¦'),
        fileMsg
    },
    ...
    startUpload = function(opts) {
        if ("object" != getType(opts)) return "å‚æ•°å¿…é¡»ä¸ºå¯¹è±¡ç±»åž‹";
        if (!opts.videoFile && !opts.fileId) return "éœ€è¦videoFileæˆ–è€…fileIdå­—æ®µ";
        if (!opts.getSignature) return "éœ€è¦getSignatureå­—æ®µ";
        if (opts.fileId) {
            if ("string" != getType(opts.fileId)) return "fileIdæ ¼å¼é”™è¯¯";
            if (!opts.coverFile) return "éœ€è¦coverFileå­—æ®µ"
        }
        if (! (isFunction(opts.getSignature) && isFunction(opts.success) && isFunction(opts.error) && isFunction(opts.progress) && isFunction(opts.finish))) return "getSignatureå¿…é¡»ä¸ºå‡½æ•°ï¼Œå¦‚æžœæœ‰successã€errorã€progressã€finishï¼Œä¹Ÿå¿…é¡»ä¸ºå‡½æ•°";
        if (opts.videoFile) {
            if (opts.allowAudio && (AllowVideoTypes = videoTypes.concat(audioTypes)), "file" != getType(opts.videoFile)) return "videoFileå¿…é¡»ä¸ºè§†é¢‘æ–‡ä»¶";
            if ( - 1 == AllowVideoTypes.indexOf(getFileMessage(opts.videoFile).type.toUpperCase())) return "videoFileå¿…é¡»ä¸ºè§†é¢‘æ–‡ä»¶"
        }
        if (opts.coverFile) {
            if ("file" != getType(opts.coverFile)) return "coverFileå¿…é¡»ä¸ºå›¾ç‰‡æ–‡ä»¶";
            if ( - 1 == imageTypes.indexOf(getFileMessage(opts.coverFile).type.toUpperCase())) return "coverFileå¿…é¡»ä¸ºå›¾ç‰‡æ–‡ä»¶"
        }
        "undefined" == getType(opts.retryStartNum) && (opts.retryStartNum = 3);
        var timeouts;
        timeouts = 3 == opts.retryStartNum ? 3e3: 2 == opts.retryStartNum ? 5e3: 1e4;
        var fileMessage = {};
        return opts.videoFile && (fileMessage.videoMsg = getFileMessage(opts.videoFile, opts.videoName), fileMessage.videoMsg.error) ? fileMessage.videoMsg.error: opts.coverFile && (fileMessage.coverMsg = getFileMessage(opts.coverFile, opts.coverName), fileMessage.coverMsg.error) ? fileMessage.coverMsg.error: void opts.getSignature(function(signature) {
            var sendParam = {};
            ...
            $.ajax({
                ...
                success: function(result, status, xhr) {
                    0 == result.code ? (opts.videoFile && setCookie(opts.videoFile.name, result.data.vodSessionKey, 24), uploadFile(opts, result, signature)) : 10005 == result.code ? (opts.videoFile && delCookie(opts.videoFile.name), startUpload(opts)) : result.code >= 2e4 && result.code <= 29999 && opts.retryStartNum > 0 ? (opts.retryStartNum--, startUpload(opts)) : errorCallBack(opts, "", result.message)()
                },
                error: function(xhr, status, error) {
                    opts.retryStartNum > 0 ? (opts.retryStartNum--, startUpload(opts)) : errorCallBack(opts, "", error)()
                }
            })
        })
    },
    uploadFile = function(opts, result, signature) {
        ...
        } else console.log("æ‚¨æ²¡æœ‰ä¸Šä¼ è§†é¢‘è§†é¢‘");
        ...
        } else console.log("æ‚¨æ²¡æœ‰ä¸Šä¼ è§†é¢‘å°é¢")
    },
    finishUpload = function(opts, result, signature) {
        ...
        $.ajax({
            ...
            success: function(result, status, xhr) {
                ...
                }) : result.code >= 2e4 && result.code <= 29999 && opts.retryFinishNum > 0 ? (opts.retryFinishNum--, finishUpload(opts, result, signature)) : errorCallBack(opts, "", result.message)()
            },
            error: function(xhr, status, error) {
                opts.retryFinishNum > 0 ? (opts.retryFinishNum--, finishUpload(opts, result, signature)) : errorCallBack(opts, "", error)()
            }
        })
    };
